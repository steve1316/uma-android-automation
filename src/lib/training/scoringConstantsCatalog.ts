...
export const SCORING_CONSTANTS_CATALOG: ReadonlyArray<ScoringConstantEntry> = [
    ...
    {
        key: "unityExtremeBurstPerGaugeBonus",
        label: "Unity extreme burst per-gauge bonus",
        description: "Additional Unity Cup Extreme Spirit Burst bonus per ready support, added on top of the extreme base bonus.",
        group: "misc",
        subgroup: "unityCup",
        defaultValue: D.unityExtremeBurstPerGaugeBonus,
        min: 0,
        max: 2500,
        step: 50,
    },
